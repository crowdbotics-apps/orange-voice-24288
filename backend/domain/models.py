...
class Domain(TimestampModel):
    ...
    darkOrange = ColorField(verbose_name='Primary Dark', default='#ED8F31')
    lightOrange = ColorField(verbose_name='Primary Light', default='#FC9834')
    white = ColorField(verbose_name='Background', default='#FFFFFF')
    steelBlue = ColorField(verbose_name='Text', default='#2C436A')
    # lightBlue = ColorField(default='#357BF3')
    fbBlue = ColorField(verbose_name='Facebook button', default='#255d9a')
    boxShadow = ColorField(default='#d4d6dc')
