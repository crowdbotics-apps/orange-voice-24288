...
import OrderHistory from '../../../assets/img/drawer/Order';
import Email from '../../../assets/img/drawer/Email';
import Question from '../../../assets/img/drawer/Question';
import Receipt from '../../../assets/img/drawer/Receipt';
import Tracking from '../../../assets/img/drawer/Tracking';
...
const listItems = (colors) => {
  return [
    ...
    },
    {
      ...
      icon: <OrderHistory fill={colors.steelBlue} />,
    },
    {
      title: 'Delivery Address',
      route: 'AddressListing',
      icon: <Tracking fill={colors.steelBlue} />,
    },
    {
      title: 'Payment Setting',
      buttonTitle: 'Save',
      route: 'CreditCardsListing',
      icon: <Receipt fill={colors.steelBlue} />,
    },
    {
      title: 'FAQs',
      route: 'CustomerLegal',
      icon: <Question fill={colors.steelBlue} />,
    },
    {
      title: 'Contact Us',
      icon: <Email fill={colors.steelBlue} />,
    },
  ];
};
...
export const Drawer = memo(({navigation}) => {
  ...
  const getDrawerHeader = () => {
    return (
      <ImageBackground
        style={{height: 260, backgroundColor: colors.darkOrange}}
        ...
        <Button
          onPress={async () => {
            ...
            try {
              ...
              console.log(
                'REFRESH TOKEN ' + access_token + ' EMAIL ' + user_email,
              );
