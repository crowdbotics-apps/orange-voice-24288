...
function DriverHistory() {
  ...
  const onTableChange = useCallback(
    (type, newState) => {
      if (type === 'pagination')
        dispatch(
          DriverActions.getDriverHistory(id, newState?.page, undefined, search),
        );
    },
    [dispatch, search, id],
  );
  ...
  const onSearch = useCallback(
    (e) => {
      ...
      if (search) {
        setIsSearch(true);
        dispatch(
          DriverActions.getDriverHistory(id, undefined, undefined, search),
        );
      }
    },
    [dispatch, search, id],
